...
5. Journey 文档正式宿主已切到 CloudBase。
6. 用户侧 Billing 页面已接通正式 API。
7. Journey assistant 已接入正式 AI 积分预占、提交与释放。

当前下一个产品里程碑不再是“把 Journey 做成可登录、可保存、可记账、可追溯”，因为这条主线已经基本接通。最新目标应调整为：

1. 补齐 token 成本、估算成本与毛利记录。
2. 完成更完整的轻量计费后台管理。
